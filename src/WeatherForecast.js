  ...
  if (loaded && props.city === forecast.city.name) {
    ...
    return (
      <div className="row scrolling-wrapper-flexbox">
        <ForecastWeatherPreview data={forecast.list[0]} />
        <ForecastWeatherPreview data={forecast.list[1]} />
        <ForecastWeatherPreview data={forecast.list[2]} />
        <ForecastWeatherPreview data={forecast.list[3]} />
        <ForecastWeatherPreview data={forecast.list[4]} />
      </div>
    );
  } else {
